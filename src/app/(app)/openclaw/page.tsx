    ...
    <div className="flex flex-col h-full" style={{ minHeight: "calc(100vh - 5rem)" }}>
      ...
      <div className="px-4 pt-4 pb-3 flex items-center justify-between shrink-0"
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 style={{ fontFamily: "var(--font-cinzel)", color: "var(--gold)", fontSize: "1rem", letterSpacing: "0.06em" }}>
              OpenClaw
            </h1>
        ...
        {iframeError && (
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-6 p-6">
            ...
            <div className="text-center space-y-2">
              <p style={{ fontFamily: "var(--font-cinzel)", color: "var(--gold)", letterSpacing: "0.06em" }}>
                OpenClaw
              </p>
