...
import { formatDate, getTodayBR } from "@/shared/lib/utils";
...
export default async function HomePage() {
  ...
  const today = formatDate(new Date(getTodayBR() + "T12:00:00"));
        ...
        <Link href="/legendarios" style={{ textDecoration: "none" }}>
          <div
            ...
            style={{
              ...
              background: "linear-gradient(135deg, rgba(120,53,15,0.15) 0%, var(--bg-card) 100%)",
            }}
          >
            <div
        ...
        <Link href="/homenagens" style={{ textDecoration: "none" }}>
          <div
            ...
            style={{
              ...
              background: "linear-gradient(135deg, var(--violet-bg) 0%, var(--bg-card) 100%)",
            }}
          >
            <div
              className="w-10 h-10 rounded-full flex items-center justify-center shrink-0"
            ...
            <div className="flex-1">
              <p
                className="text-xs font-bold leading-tight"
                style={{ color: "var(--violet)", fontFamily: "var(--font-cinzel)", letterSpacing: "0.04em" }}
              >
                Homenagens
              </p>
              <p className="text-xs mt-1 leading-snug" style={{ color: "var(--text-muted)" }}>
          ...
          <div className="card p-6 h-full">
            ...
            {devotional ? (
              ...
              <div className="flex flex-col items-center justify-center h-40 space-y-3">
                ...
                <p className="scripture text-sm text-center" style={{ color: "var(--text-muted)" }}>
                ...
                {prayers.map((prayer) => (
                  <div key={prayer.id} className="space-y-1">
                    ...
                    <p className="text-xs" style={{ color: "var(--text-subtle)" }}>
                      {(prayer as unknown as { profile?: { full_name?: string; church_name?: string } }).profile?.full_name} ·{" "}
                      {(prayer as unknown as { profile?: { full_name?: string; church_name?: string } }).profile?.church_name}
                    </p>
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p
              ...
              style={{ color: "var(--violet)", fontFamily: "var(--font-cinzel)", letterSpacing: "0.06em" }}
            >
