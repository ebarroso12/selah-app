      ...
      {tab === "senha" && (
        <form onSubmit={handleChangePassword} className="space-y-5 max-w-sm">
          <div>
            ...
            <input id="current_pw" type="password" className="input-field" placeholder="Sua senha atual"
          ...
          <div>
            ...
            <input id="new_pw" type="password" className="input-field" placeholder="Mínimo 8 caracteres"
          ...
          <div>
            ...
            <input id="confirm_pw" type="password" className="input-field" placeholder="Repita a nova senha"
