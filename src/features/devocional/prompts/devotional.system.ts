/**
 * Prompt do devocional diário — Task 5.2
 * Copiado de src/lib/ai/devotional-prompt.ts (PRD Apêndice F)
 */

export interface DevotionalPromptInput {
  bibleBook: string;
  bibleChapter: number;
...
export function buildDevotionalPrompt(input: DevotionalPromptInput): string {
